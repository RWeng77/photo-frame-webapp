...
export default function App() {
  ...
  const [frame, setFrame] = useState("/2025-FCU-photo-frame-webapp/frames/frame1.png");
    ...
    <div
      ...
      style={{
        backgroundImage: showFrames
          ? "url('/2025-FCU-photo-frame-webapp/background/background2.jpg')"
          : "url('/2025-FCU-photo-frame-webapp/background/background1.png')",
